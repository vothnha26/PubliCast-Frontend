  ...
  const columns = [
    {
      ...
      renderCell: (item) => (
        <div className="flex items-center gap-4">
          <div className="w-16 h-10 bg-muted rounded-lg overflow-hidden relative shadow-sm border border-border shrink-0">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold text-foreground truncate max-w-[200px]">{item.title}</span>
          </div>
        </div>
      )
    },
