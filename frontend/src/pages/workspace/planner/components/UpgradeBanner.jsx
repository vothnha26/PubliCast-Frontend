    ...
    <div className="bg-card border border-border rounded-2xl p-3.5 sm:p-4 flex items-center justify-between shadow-sm relative overflow-hidden group min-h-[72px] no-print transition-all">
      ...
      <div className="flex gap-3.5 items-center relative z-10 pr-4">
        ...
        <div className="w-10 h-10 rounded-full bg-lime-500/10 border border-lime-500/30 flex items-center justify-center shrink-0 shadow-sm">
          ...
          <div className="w-7 h-7 rounded-full bg-lime-400/30 flex items-center justify-center text-xs">💎</div>
        </div>
        <div>
          <h3 className="text-xs font-extrabold text-foreground">{t("upgrade.title", { defaultValue: "Do you need a higher plan?" })}</h3>
          <p className="text-[11px] text-muted-foreground font-bold mt-0.5">
            <Trans
              ...
              components={{
                span: <span className="text-foreground font-extrabold" />
              }}
            >
      ...
      <div className="flex items-center gap-2.5 relative z-10 shrink-0">
        ...
        <button
          ...
          className="w-7 h-7 flex items-center justify-center rounded-full text-muted-foreground hover:text-foreground hover:bg-muted transition-colors cursor-pointer border-none bg-transparent"
        >
          <X size={15} />
        </button>
      </div>
