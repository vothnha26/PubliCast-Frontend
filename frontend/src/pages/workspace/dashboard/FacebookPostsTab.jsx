...
function ViewChartBtn({ children }) {
  return (
    <button className="flex items-center gap-1.5 text-[10px] font-bold text-muted-foreground hover:text-indigo-500 transition-colors">
      <Clock size={12} />
      {children}
    </button>
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-card p-6 rounded-3xl border border-border shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-sm font-bold text-foreground">Types</h4>
          ...
          <div className="bg-card p-6 rounded-3xl border border-border shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-sm font-bold text-foreground">Views</h4>
