    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Người theo dõi</p>
            <p className="text-2xl font-black text-gray-900 mt-1">{followersCount.toLocaleString()}</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Đang theo dõi</p>
            <p className="text-2xl font-black text-gray-900 mt-1">{followsCount.toLocaleString()}</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Tổng số bài viết</p>
            <p className="text-2xl font-black text-gray-900 mt-1">{postsCount.toLocaleString()}</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Xác thực Video</p>
