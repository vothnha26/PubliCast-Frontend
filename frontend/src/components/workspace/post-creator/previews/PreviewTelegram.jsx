  ...
  return (
    ...
    >
      <div className="flex flex-col h-full bg-[#f4f7f9] p-4 text-left font-sans">
        {/* Channel Info Header */}
        <div className="flex items-center gap-3 border-b border-border/80 pb-3 mb-3 shrink-0">
          ...
          <div>
            <h4 className="text-xs font-bold text-foreground leading-tight">{pageName}</h4>
            <p className="text-[10px] text-muted-foreground leading-tight">subscribers</p>
          </div>
        </div>

        {/* Telegram Chat Bubble Container */}
        <div className="flex-1 flex flex-col justify-end">
          <div className="max-w-[85%] bg-card rounded-2xl rounded-tl-none shadow-sm border border-border overflow-hidden self-start">
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="flex items-center justify-between text-[9px] text-muted-foreground font-medium pt-1">
          ...
          <div className="flex items-center justify-between mt-4 px-2 text-[10px] font-semibold text-[#0088cc] shrink-0 border-t border-border pt-2">
            <button className="flex items-center gap-1.5 hover:bg-muted px-3 py-1.5 rounded-full transition-all cursor-pointer">
              <Send size={12} />
              <span>Discuss</span>
            </button>
            <button className="flex items-center gap-1.5 hover:bg-muted px-3 py-1.5 rounded-full transition-all cursor-pointer">
